...
% Background
\ThisCenterWallPaper{1.0}{ku-logo.pdf}
\ThisCenterWallPaper{1.0}{ku-english.pdf}

\AddToShipoutPicture*{\put(100,120){Supervisor: Wouter Krogh Boomsma}}
\AddToShipoutPicture*{\put(100,80){\small *Equal contribution}}
