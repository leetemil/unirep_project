...
% In total the GRU is made up of one hidden state and two gates, effectively decreasing the number of gradient computations in comparison to the LSTM alternative.
...
We have used what the authors call the 5 core tasks of TAPE, namely \todo{give short description of each task}:
\begin{enumerate}
