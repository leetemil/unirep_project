...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig2b_GRU_1024_no_trunc.pdf}
...
\end{tabularx}
\caption{Results for 4 of the 5 TAPE tasks. The metric for secondary structure and remote homology is accuracy; for fluorescence and stability it is Spearman's $\rho$. The results for the UniRep model was taken from \url{https://github.com/songlab-cal/tape}.}
