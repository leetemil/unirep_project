...
parser.add_argument("data", type = Path, help = "File to load data from")
...
parser.add_argument("--print_every", type = int, default = 100, help = "How many batches between printing training progress.")
parser.add_argument("--save_every", type = int, default = 100, help = "How many batches between saving the model.")
