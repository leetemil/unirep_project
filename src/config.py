...
parser.add_argument("--print_every", type = int, default = 20, help = "How many batches between printing training progress.")
parser.add_argument("--save_every", type = int, default = 20, help = "How many batches between saving the model.")
